...
export const APP_CONFIG = {
    sharedDriveId: process.env.SHARED_DRIVE_ID || process.env.GOOGLE_SHARED_DRIVE_ID!, 
    projectsFolderId: process.env.PROJECTS_FOLDER_ID || process.env.SHARED_DRIVE_ID || process.env.GOOGLE_SHARED_DRIVE_ID!, // Where projects are stored
